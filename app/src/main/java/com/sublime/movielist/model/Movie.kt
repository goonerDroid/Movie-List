...
import com.sublime.movielist.model.Movie.Companion.TABLE_NAME
import kotlinx.android.parcel.Parcelize

/**
 * Data class for Database entity and Serialization for Movie.
 */
@Keep
@Parcelize
...
data class Movie (
    ...
    companion object {
        const val TABLE_NAME = "movies_data"
    }
}